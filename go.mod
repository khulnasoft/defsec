...
require (
	...
	github.com/elgohr/go-localstack v1.0.40 // indirect
...
replace github.com/elgohr/go-localstack => github.com/khulnasoft/go-localstack v0.0.0-20231208052034-5cf5c5ea00ee
