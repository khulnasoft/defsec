...
```
wget https://github.com/khulnasoft/defsec/raw/master/policies/kubernetes/lib/kubernetes.rego
wget https://github.com/khulnasoft/defsec/raw/master/policies/kubernetes/lib/utils.rego
wget https://github.com/khulnasoft/defsec/raw/master/policies/defsec/lib/defsec.rego
wget https://github.com/khulnasoft/defsec/raw/master/policies/kubernetes/policies/pss/baseline/1_host_ipc.rego
```
3. Download an example of a non-compliant kubernetes deployment (in yaml format) 
```
wget https://github.com/khulnasoft/defsec/raw/master/test/testdata/kubernetes/KSV008/denied.yaml
```
...
The REGO rules are available [here](https://github.com/khulnasoft/defsec/tree/master/policies/kubernetes/policies/pss)
...
Additional REGO rules available [here](https://github.com/khulnasoft/defsec/tree/master/policies/kubernetes/policies/advanced/optional)
